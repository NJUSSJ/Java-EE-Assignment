<%@ page import="edu.nju.weborder.model.Product" %><%--
...
<body>
    ...
    <jsp:useBean id="products" type="edu.nju.weborder.action.business.ProductListBean" scope="session"/>
    <%pageContext.setAttribute("product", products.getProducts().get(0));%>
    <jsp:useBean id="product" type="edu.nju.weborder.model.Product"/>
